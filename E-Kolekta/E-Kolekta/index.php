...
<body>
    ...
    <section class="hero">
        ...
        <div class="hero-content">
            <h1>Your Solution for E-Waste Disposal</h1>
            <p>E-Kolekta simplifies electronic waste recycling with convenient pickup and drop-off services, rewarding your efforts for a cleaner, greener community.</p>
        </div>
    </section>
